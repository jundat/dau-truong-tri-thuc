...
{
	CCLOG("NDKHelper::Add selector: %s (in group %s)", name, groupName);
...
void NDKHelper::CallJNIFunction( string jniFuncName, CCObject* jniFuncParams, const char *callbackFuncName, SEL_CallFuncND selector, CCNode* target )
{
    ...
    #define CLASS_NAME "com/jundat/dautruongtrithuc/classes/AndroidNDKHelper"
#endif
...
extern "C"
{
    ...
    void Java_com_jundat_dautruongtrithuc_classes_AndroidNDKHelper_CPPNativeCallHandler(JNIEnv* env, jobject thiz, jstring json)
    {
