...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	{
		pScene = MenuScene::scene(); //  TestPostGetScene::scene(); // TestAndroidFacebookScene::scene(); // TestPostGetScene::scene(); // IntroScene::scene(); //  MenuScene::scene(); //  MainGameScene::scene(); //
	}
